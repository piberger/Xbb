    ...
    def __init__(self, sampleTree, isData=False):
        ...
        if sampleTree.treeName == 'tree':
            ...
            self.formulas = {
                    'hJetInd1': 'hJidx[0]',
                    'hJetInd2': 'hJidx[1]',
                    'hj1_pt': 'Jet_Pt[hJidx[0]]',
                    'hj1_eta': 'Jet_eta[hJidx[0]]',
                    'hj1_phi': 'Jet_phi[hJidx[0]]',
                    'hj1_mass': 'Jet_mass[hJidx[0]]',
                    'hj2_pt': 'Jet_Pt[hJidx[1]]',
                    ...
                    'GenBJ2_phi': '-1' if isData else '-1', #'GenJet_phi[Jet_genJetIdx[hJidx[1]]]',
                    'GenBJ1_pt': '-1' if isData else '-1', #'GenJet_pt[Jet_genJetIdx[hJidx[0]]]',
                    'GenBJ2_pt': '-1' if isData else '-1', #'GenJet_pt[Jet_genJetIdx[hJidx[1]]]',
