...
# global path
pathin_ = 'root://t3dcachedb03.psi.ch:1094//pnfs/psi.ch/cms/trivcat/store/user/gaperrin/VHbb/VHbbPostNano2016/Wlv/sys_v4/TT_TuneCUETP8M2T4_13TeV-powheg-pythia8/'
...
for var in VarList:
    for syst in SysList:
        ...
        xmin = 0
        xmax = 0
        var_nom = var.replace('_SYS','').replace('_UD','').replace('_CAT','').replace('_corr','').replace('.SYS_UD','.Nominal')
