...
#ROOT.gSystem.Load("./BTagCalibrationStandalone.so")
csvpath = '/mnt/t3nfs01/data01/shome/gaperrin/VHbb/CMSSW_7_4_3/src/Xbb/python/csv'
#ROOT.gSystem.Load(csvpath+'/BTagCalibrationStandalone_cpp.so')

# CSVv2
#calib_csv = ROOT.BTagCalibration("csvv2", csvpath+"/CSVv2_ichep.csv")
calib_csv = ROOT.BTagCalibration("csvv2", csvpath+"/ttH_BTV_CSVv2_13TeV_2016EF_7p2_2016_09_23.csv")

# cMVAv2
#calib_cmva = ROOT.BTagCalibration("cmvav2", csvpath+"/cMVAv2_ichep.csv")
calib_cmva = ROOT.BTagCalibration("cmvav2", csvpath+"/ttH_BTV_cMVAv2_13TeV_2016EF_7p2_2016_09_23.csv")
